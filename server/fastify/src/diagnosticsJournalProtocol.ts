import type { RemoteDiagnosticRecordV4 } from '@risuai/protocol/remote-diagnostics'
...
export type PendingDiagnosticRecord = Omit<RemoteDiagnosticRecordV4, 'sequence'>
