...
describe('route protection (table-wide auth enforcement)', () => {
  ...
  it('keeps mutating active-writer exceptions within the independently reviewed allowlist', () => {
    const reviewedExceptions = [
      ...
      'chat-occupancy-claim:auth-session',
      'chat-occupancy-renew:auth-session',
      'chat-occupancy-release:auth-session',
      'chat-occupancy-switch:auth-session',
      'chat-occupancy-normalize:auth-session',
      ...
      'generation-operation-submit:auth-session',
      'generation-operation-cancel:auth-session',
      'generation-operation-retry:auth-session',
