...
| [Performance and stability](performance-and-stability/README.md)             | Frontend test/runtime and clone narrowing, the exhaustive test-suite effectiveness audit, the retired 2026-09 test inventory and worklist, chat multitasking regressions, and four chronological stability/performance audits.          |
...
| [UI and user input](ui-and-user-input/README.md)                             | Unified role-first workspace, connected-reader lifecycle, per-chat occupancy and chat-only generation, shared UI, visible-state and persistence audits, input hooks, chat/settings controls, stale-state reviews, and hardening. |
