...
| [UI and user input](ui-and-user-input/README.md)                             | Unified role-first workspace, connected-reader lifecycle and shared UI, visible-state and persistence audits, input hooks, chat/settings controls, stale-state reviews, and hardening. |
