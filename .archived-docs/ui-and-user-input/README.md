...
| Record                                                             | Scope                                                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Chat occupancy and chat-only devices](chat-occupancy/PLAN.md)     | One general owner plus exclusive per-chat authority, scoped multi-device Send/Reroll/Stop, durable recovery and effects, rollback/drain, and [completed evidence](chat-occupancy/status.md).                                                                                                         |
| [Unified read-only workspace](unified-read-only-workspace/PLAN.md) | Sole role-first connected startup path, persistent reader/writer workspace frame, contained read-only composer, explicit device promotion, stable transitions, telemetry cleanup, and [completed evidence](unified-read-only-workspace/status.md).                                                   |
| [Read-only shell parity](read-only-shell-parity/PLAN.md)           | Shared reader/writer frame and geometry, bottom takeover action, explicit-cause sidebar motion, and per-frame transition proof; [completed evidence](read-only-shell-parity/status.md).                                                                                                              |
