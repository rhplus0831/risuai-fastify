export const languageSpanish = {
  connectedReaders: {
    chatOccupancy: {
      unsupported: 'El acceso solo al chat no está disponible',
      unsupportedHelp: 'Este servidor no admite la interacción solo con el chat. Puedes seguir leyendo.',
      disabled: 'El acceso solo al chat está desactivado',
      disabledHelp: 'El acceso a nuevos chats está desactivado temporalmente. Puedes seguir leyendo.',
      identityUnavailable: 'Esta pestaña no puede usar el acceso solo al chat',
      identityUnavailableHelp: 'Usa la pestaña original o recarga esta página. Aquí puedes seguir leyendo.',
      available: 'Disponible en este dispositivo',
      availableHelp: 'Ocupa este chat de forma explícita para enviar o regenerar. Navegar no lo ocupa.',
      foreignOwned: 'En uso en otro dispositivo',
      ...
      normalizationRequiredHelp:
        'Este dispositivo conservó varios chats al perder el acceso general de escritura. Conserva este antes de interactuar.',
      normalizationElsewhere: 'Elige primero un chat conservado',
      ...
      normalizing: 'Actualizando…',
      inputPlaceholder: 'Escribe un mensaje',
      sending: 'Enviando…',
      reroll: 'Regenerar la última respuesta',
      rerolling: 'Regenerando…',
      ...
      sendAccepted: 'Mensaje aceptado.',
      sendQueued:
        'Este mensaje sigue guardado en este dispositivo; aún no se puede confirmar si el servidor lo aceptó.',
      sendFailed: 'El mensaje no fue aceptado. Tu borrador sigue aquí.',
      rerollAccepted: 'Regeneración aceptada.',
      rerollRetained:
        'La regeneración sigue guardada en este dispositivo; aún no se puede confirmar si el servidor la aceptó.',
      rerollFailed: 'La regeneración no fue aceptada. La respuesta existente no cambió.',
      stopRequested: 'Se solicitó detener. Esperando que el servidor concilie la respuesta.',
      stopFailed: 'No se pudo confirmar la detención. Es posible que la generación siga en curso.',
      actionUnavailable: 'Esta acción no está disponible ahora. Actualiza e inténtalo de nuevo.',
      actionFailed: 'No se pudo cambiar el acceso al chat. Actualiza e inténtalo de nuevo.',
      recoveryBlocked: 'El trabajo aceptado debe terminar o detenerse antes de liberar o cambiar este chat.',
    },
  },
  generationRecovery: {
    failed:
  ...
  help: {
    ...
    charjs:
      'Un código JavaScript que se ejecutará con el personaje. Por ejemplo, puedes consultar `https://github.com/kwaroran/Risuai/blob/main/src/etc/example-char.js` ACTUALMENTE NO SE RECOMIENDA USAR DEBIDO A PROBLEMAS DE SEGURIDAD. EXPORTAR NO INCLUIRÁ ESTO.',
    romanizer:
    ...
    strictJsonSchema:
      'Si está habilitado, seguirá estrictamente el esquema proporcionado para JSON en algunos modelos. Si está deshabilitado, puede ignorar el esquema JSON.',
    extractJson:
    ...
    legacyMediaFindings:
      'Si está habilitado, usará el método antiguo para encontrar activos multimedia, sin usar el algoritmo de búsqueda adicional.',
    comfyWorkflow:
    ...
    automaticCachePoint:
      'Crea automáticamente un punto de caché después de que termina el chat, si el punto de caché no existe.',
    ...
    dynamicMemory:
      'Cuando está habilitado, el asistente tomará notas de memoria en el tiempo de respuesta. Se requiere prompting adicional para utilizar esta característica.',
    dynamicResponseTiming: 'Cuando está habilitado, ajustará el tiempo de respuesta dinámicamente.',
    dynamicRequest:
      'Cuando está habilitado, solicitará al modelo en un momento aleatorio sin esperar la entrada del usuario.',
    ...
    enableScrollToActiveChar:
      'Si está habilitado, pulsar la tecla de acceso rápido o mantener presionada la tecla Ctrl mientras se arrastra un personaje desplazará la vista hasta el personaje activo. Las carpetas se abrirán automáticamente si están cerradas.',
  },
  setup: {
    ...
    claudeDesc:
      'Claude es un modelo de IA creado por Anthropic, competidor de OpenAI. Es mejor que GPT si quieres usarlo en otros idiomas además del inglés.',
    openAIDesc:
      'OpenAI GPT es un modelo de IA de alta calidad, pero es de pago y filtrado, y débil en otros idiomas que no sean inglés.',
    chooseChatType: '¡Genial! Ahora selecciona el idioma del chat.',
    chooseChatTypeOption1: 'Todo en Inglés',
    chooseChatTypeOption1Desc:
      'Esto hará que la IA use inglés y entrada/salida en inglés. Recomendado para hablantes de inglés.',
    ...
    finallyOption1: 'Sí',
    finallyOption1Desc:
      'Esto habilitará herramientas avanzadas, pero hará que la interfaz de usuario sea más compleja. Recomendado para usuarios avanzados.',
    finallyOption2: 'No',
    finallyOption2Desc:
      'Esto deshabilitará las herramientas avanzadas y hará que la interfaz de usuario sea más simple. Recomendado para nuevos usuarios.',
    igpPrompt:
  ...
  triggerDesc: {
    ...
    v2QuickSearchChatDesc:
      'Búsqueda rápida {{value}} en chat con condición {{condition}} en profundidad {{depth}} => {{outputVar}}',
  ...
  chatListExportAll: 'Exportar todos los chats',
  chatListImport: 'Importar chat',
  chatListEdit: 'Editar lista de chats',
  chatListCreateFolder: 'Crear carpeta de chats',
  ...
  organizeCharacters: 'Organizar personajes',
  characterActionsFor: (name: string) => `Organizar ${name}`,
  folderActionsFor: (name: string) => `Acciones de carpeta para ${name}`,
  moveToFolder: 'Mover a una carpeta',
  moveOutOfFolder: 'Sacar de la carpeta',
  createFolderWith: 'Crear carpeta con…',
  chooseDestinationFolder: 'Elige una carpeta de destino',
  chooseFolderPartner: 'Elige un personaje para la nueva carpeta',
  newCharacterFolderName: 'Nueva carpeta',
  chooseFolderColor: 'Elige un color de carpeta',
  resetFolderImage: 'Restablecer imagen predeterminada',
  selectFolderImageFile: 'Seleccionar archivo de imagen',
  folderColorRed: 'Rojo',
  folderColorGreen: 'Verde',
  folderColorBlue: 'Azul',
  folderColorYellow: 'Amarillo',
  folderColorIndigo: 'Índigo',
  ...
  importTranslationCacheConfirm:
    'Esto fusionará las entradas en la caché de traducción. Las claves existentes se sobrescribirán. ¿Continuar?',
  importTranslationCacheSuccess: 'Se importaron {0} entradas del caché de traducción.',
  importTranslationCacheFailed:
    'Se importaron {0} entradas, pero {1} entradas no se pudieron guardar. El almacenamiento puede estar lleno.',
  ...
  clearTranslationCacheConfirm:
    'Esto eliminará todas las entradas de la caché de traducción. Esta acción no se puede deshacer. ¿Continuar?',
  loading: 'Cargando',
  ...
  staticsDisclaimer:
    'Las estadísticas se basan en los datos de después de julio de 2024. Los datos pueden no ser precisos.',
  ...
  hypaV3Modal: {
    ...
    previousSearchResultAction: 'Resultado de búsqueda anterior',
    nextSearchResultAction: 'Siguiente resultado de búsqueda',
    ...
    selectSummaryAction: 'Seleccionar resumen #{0}',
    deselectSummaryAction: 'Anular la selección del resumen #{0}',
    summaryCategoryLabel: 'Categoría del resumen #{0}',
    toggleSummaryTranslationAction: 'Mostrar u ocultar la traducción del resumen',
    toggleSummaryImportantAction: 'Alternar la marca de resumen importante',
    rerollSummaryAction: 'Regenerar resumen',
    deleteSummaryAction: 'Eliminar resumen',
    deleteFollowingSummariesAction: 'Eliminar los resúmenes posteriores',
    toggleRerolledSummaryTranslationAction: 'Mostrar u ocultar la traducción del resumen regenerado',
    cancelRerollAction: 'Cancelar la regeneración del resumen',
    applyRerollAction: 'Aplicar el resumen regenerado',
    toggleConnectedMessageTranslationAction: 'Mostrar u ocultar la traducción del mensaje vinculado',
    bulkCategoryLabel: 'Categoría de los resúmenes seleccionados',
    toggleBulkImportantAction: 'Alternar la marca importante de los resúmenes seleccionados',
    bulkSelectionInputLabel: 'Números de resumen que se seleccionarán',
    toggleResummaryTranslationAction: 'Mostrar u ocultar la traducción del nuevo resumen',
    retryResummaryAction: 'Reintentar el nuevo resumen',
    applyResummaryAction: 'Aplicar el resultado del nuevo resumen',
    cancelResummaryAction: 'Cancelar el nuevo resumen',
    addCategoryAction: 'Agregar categoría',
    saveCategoryAction: 'Guardar categoría',
    cancelCategoryEditAction: 'Cancelar la edición de categoría',
    editCategoryAction: 'Editar categoría',
    deleteCategoryAction: 'Eliminar categoría',
    tagNameLabel: 'Nombre de etiqueta',
    saveTagAction: 'Guardar etiqueta',
    cancelTagEditAction: 'Cancelar la edición de etiqueta',
    editTagAction: 'Editar etiqueta',
    deleteTagAction: 'Eliminar etiqueta',
    refreshMemoryJobsAction: 'Actualizar tareas de memoria',
  ...
  childLoreDesc:
    "Esta es una copia del lore del Personaje que permanece 'Siempre Activo' hasta que se elimine o desactive manualmente en el original.",
  ...
  stackTraceTranslationFailed:
    'La traducción del seguimiento de pila falló. Se muestra abajo el seguimiento de pila ofuscado original.',
  ...
  pluginNoRiskButAlert:
    'Risuai no detectó código dañino, pero ten en cuenta que instalar plugins de fuentes no confiables puede plantear riesgos de seguridad.',
  ...
  pluginRisksInuserFriendlyDesc: {
    ...
    globalAccess:
      'El plugin intenta acceder a variables globales, lo que puede llevar a efectos secundarios no deseados o vulnerabilidades de seguridad.',
    thisOutsideClass:
      "El plugin usa la palabra clave 'this' fuera del contexto de clase, lo que puede llevar a un comportamiento no deseado o problemas de seguridad.",
    errorInVerification:
      'Hay errores durante el proceso de verificación del plugin, indicando problemas potenciales con su funcionalidad.',
    storageAccess:
  ...
  settingsNavInputHooks: 'Hooks de entrada',
  inputHooks: 'Hooks de entrada',
  inputHookTypeDraft: 'Borrador',
  ...
  inputHookSelectDraft: 'Seleccionar hook de borrador',
  inputHookDraftDialogTitle: 'Seleccionar hook de borrador',
  inputHookNone: 'Ninguno',
  inputHookBtw: 'BTW',
  inputHookBtwDialogTitle: 'Ejecutar hook BTW',
  inputHookBtwResult: 'Resultado BTW',
  inputHookBtwDismiss: 'Cerrar resultado BTW',
  inputHookSendDraft: 'Enviar borrador',
