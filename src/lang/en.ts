export const languageEnglish = {
  ...
  observerShell: {
    ...
    status:
      'You can browse while this tab waits for write access. Your latest navigation will be applied when it is safe to save.',
    statusRetrying: 'Trying to restore write access without leaving this preview…',
    statusTakeoverDenied: 'Another session still has write access. This preview remains available.',
    statusUnavailable: 'Write access is temporarily unavailable. This preview remains available.',
    statusWriterLost: 'Write access moved to another session. This authenticated preview is still available.',
    statusOffline: 'This tab is staying in read-only mode. You can retry write access when you are ready.',
    statusAuthLost: 'Your authenticated preview was cleared because this session is no longer authorized.',
    statusPromoted: 'Write access is restored. Finishing the transition to the full app…',
    retryWriter: 'Retry write access',
    retryingWriter: 'Retrying write access…',
    readOnlyBadge: 'Read only',
    navigationLabel: 'Read-only navigation',
    charactersLabel: 'Characters',
    noCharacters: 'No characters are available.',
    ...
    chatsLabel: 'Chats',
    pinnedChatsHelp: 'Pinned chats available in the summary:',
    openChat: (name: string) => `Open chat ${name}`,
    noChats: 'No chat details are loaded.',
  ...
  bardWiki: {
    ...
    modeHybrid: 'Hybrid',
    totalTokenBudget: 'Total memory token budget',
    hybridHypaTokenBudget: 'Hybrid Hypa budget',
    hybridBardWikiTokenBudget: 'Hybrid BardWiki budget',
    maxDocuments: 'Maximum selected documents',
    maxLinkHops: 'Maximum link hops',
    recentMessageCount: 'Recent query messages',
    modelProfile: 'Analysis model profile',
