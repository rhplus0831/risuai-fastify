export const languageGerman = {
  ...
  errors: {
    ...
    requestLogRemovedDesc:
      'Dieses Anfrage-Protokoll wird entfernt, wenn der Client aktualisiert oder neu geladen wird.',
  ...
  help: {
    ...
    charjs:
      'Ein Javascript-Code, der mit dem Charakter ausgeführt wird. Sie können zum Beispiel `https://github.com/kwaroran/Risuai/blob/main/src/etc/example-char.js` überprüfen. ZURZEIT AUS SICHERHEITSGRÜNDEN NICHT EMPFOHLEN. BEIM EXPORTIEREN WIRD DIES NICHT ENTHALTEN SEIN.',
    romanizer:
    ...
    inlayImages:
      'Wenn aktiviert, können Bilder in den Chat eingefügt werden und KIs können sie sehen, wenn sie dies unterstützen.',
    metrica:
    ...
    showUnrecommended:
      'Wenn aktiviert, werden nicht empfohlene, veraltete Einstellungen angezeigt. Es wird NICHT EMPFOHLEN, diese Einstellungen zu verwenden.',
    imageCompression:
    ...
    forcePlainFetch:
      'Wenn aktiviert, wird die Browser-Fetch-API anstelle der nativen HTTP-Anfrage verwendet. Dies kann zu CORS-Fehlern führen.',
    autoFillRequestURL:
      'Wenn aktiviert, wird die Anfrage-URL automatisch ausgefüllt, um dem aktuellen Modell zu entsprechen.',
    ...
    requestretrys:
      'Diese Option wird verwendet, um die Anzahl der Anfrage-Wiederholungsversuche festzulegen, wenn eine Anfrage fehlschlägt.',
    emotionPrompt:
    ...
    dynamicAssetsEditDisplay:
      "Wenn aktiviert, werden dynamische Assets auch auf die Phase 'Modify Display' angewendet. Dies kann jedoch zu Leistungsproblemen führen.",
    nickname:
      'Der Spitzname wird im Chat anstelle des Charakternamens in {{char}} oder <char> verwendet, falls er festgelegt ist.',
    useRegexLorebook:
      'Wenn aktiviert, wird Regex anstelle von String-Abgleich für die Lorebook-Suche verwendet. Es verwendet das Format /regex/flags.',
    ...
    systemContentReplacement:
      'Das Anweisungsformat, das die Systemanweisung ersetzt, wenn das Modell keine Systemanweisung unterstützt.',
    ...
    legacyMediaFindings:
      'Wenn aktiviert, wird die alte Methode zum Auffinden von Medien-Assets verwendet, ohne den zusätzlichen Suchalgorithmus zu verwenden.',
    comfyWorkflow:
    ...
    automaticCachePoint:
      'Erstellt automatisch einen Cache-Punkt nach dem Ende des Chats, wenn der Cache-Punkt nicht existiert.',
    ...
    dynamicMessages:
      'Wenn aktiviert, kann der Assistent mehrere Nachrichten hintereinander senden, anstatt nur eine nach der anderen.',
    dynamicMemory:
      'Wenn aktiviert, macht der Assistent Gedächtnisnotizen zur Antwortzeit. Um diese Funktion nutzen zu können, ist eine zusätzliche Anweisung erforderlich.',
    dynamicResponseTiming: 'Wenn aktiviert, wird das Antwort-Timing dynamisch angepasst.',
    dynamicRequest:
      'Wenn aktiviert, wird das Modell zu einem zufälligen Zeitpunkt angefordert, ohne auf eine Benutzereingabe zu warten.',
    settingsCloseButtonSize:
      'Passt die Größe der Schließen-Schaltfläche (X) in der oberen rechten Ecke des Einstellungsfensters an. Standard ist 24.',
    showTypingEffect:
      'Wenn aktiviert, wird während der Generierung einer Antwort durch den Assistenten eine Tippanzeige angezeigt.',
    dynamicOutputPrompt: 'Wenn aktiviert, werden die Schema-Informationen in die Anfrage aufgenommen.',
    realmDirectOpen:
      'Wenn aktiviert, öffnet ein Klick auf einen Charakter in der RisuRealm-Vorschau direkt die Charakterbeschreibung.',
    ...
    enableScrollToActiveChar:
      'Wenn aktiviert, wird durch Drücken des Hotkeys oder Halten der Strg-Taste beim Ziehen eines Charakters zum aktuell aktiven Charakter gescrollt. Geschlossene Ordner werden automatisch geöffnet.',
  },
  setup: {
    ...
    welcome:
      'Willkommen bei Risuai! Ich bin Airisu und werde Sie durch die Einrichtung von Risuai führen. Zuerst, wie darf ich Sie nennen?',
    welcome2:
    ...
    openRouterProvider:
      'OpenRouter hat viele Modelle, einige davon ungefiltert und einige davon kostenlos, aber es ist nicht so gut wie OpenAI.',
    hordeProvider: 'Horde ist ein kostenloser Anbieter, aber die Antwortzeit ist lang und die Qualität ist gering.',
    setProviderLater:
      'Es gibt andere Anbieter, aber Sie können dies später in den Einstellungen festlegen. Wählen Sie dies, wenn Sie es später einstellen möchten.',
    setupOpenAI:
    ...
    setupLaterMessage:
      'Willkommen {username}! Möchten Sie, dass ich Sie durch die Einrichtung führe oder möchten Sie es selbst tun?',
    ...
    claudeDesc:
      'Claude ist ein KI-Modell von Anthropic, einem Konkurrenten von OpenAI. Es ist besser als GPT, wenn Sie es in anderen Sprachen als Englisch verwenden möchten.',
    openAIDesc:
      'OpenAI GPT ist ein qualitativ hochwertiges KI-Modell, aber es ist kostenpflichtig und gefiltert und in anderen Sprachen als Englisch schwach.',
    ...
    chooseChatTypeOption1Desc:
      'Dadurch wird die KI Englisch verwenden und Ein-/Ausgabe erfolgt auf Englisch. Empfohlen für englischsprachige Benutzer.',
    chooseChatTypeOption2: 'Englische Verarbeitung',
    chooseChatTypeOption2Desc:
      'Dadurch wird die KI intern Englisch verwenden, aber die Ein-/Ausgabe erfolgt in Ihrer Sprache. Empfohlen für nicht englischsprachige Benutzer.',
    chooseChatTypeOption3: 'Keine Sprache fokussiert',
    chooseChatTypeOption3Desc:
      'Dadurch wird die KI Ihre Sprache intern verwenden, dies könnte jedoch die Qualität verringern.',
    ...
    chooseCheapOrMemoryOption3Desc:
      'Dadurch wird sich die KI an mehr erinnern als bei Günstig, aber an weniger als bei Speicher.',
    ...
    finallyOption1: 'Ja',
    finallyOption1Desc:
      'Dadurch werden erweiterte Tools aktiviert, aber die Benutzeroberfläche wird komplexer. Empfohlen für fortgeschrittene Benutzer.',
    finallyOption2: 'Nein',
    finallyOption2Desc:
      'Dadurch werden erweiterte Tools deaktiviert und die Benutzeroberfläche vereinfacht. Empfohlen für neue Benutzer.',
    igpPrompt:
  ...
  triggerDesc: {
    ...
    v2QuickSearchChatDesc:
      'Schnellsuche nach {{value}} im Chat mit Bedingung {{condition}} in Tiefe {{depth}} => {{outputVar}}',
    ...
    v2ModifyLorebookByIndexDesc:
      'Lore-Buch bei Index {{index}} mit Namen {{name}}, Schlüssel {{key}}, Inhalt {{content}} ändern',
  ...
  reroll: 'Regenerieren',
  chatList: 'Chatliste',
  chatListExportAll: 'Alle Chats exportieren',
  chatListImport: 'Chat importieren',
  chatListEdit: 'Chatliste bearbeiten',
  chatListCreateFolder: 'Chatordner erstellen',
  ...
  organizeCharacters: 'Charaktere organisieren',
  characterActionsFor: (name: string) => `${name} organisieren`,
  folderActionsFor: (name: string) => `Ordneraktionen für ${name}`,
  moveToFolder: 'In Ordner verschieben',
  moveOutOfFolder: 'Aus Ordner verschieben',
  createFolderWith: 'Ordner erstellen mit…',
  chooseDestinationFolder: 'Zielordner auswählen',
  chooseFolderPartner: 'Charakter für den neuen Ordner auswählen',
  newCharacterFolderName: 'Neuer Ordner',
  chooseFolderColor: 'Ordnerfarbe auswählen',
  resetFolderImage: 'Standardbild wiederherstellen',
  selectFolderImageFile: 'Bilddatei auswählen',
  folderColorRed: 'Rot',
  folderColorGreen: 'Grün',
  folderColorBlue: 'Blau',
  folderColorYellow: 'Gelb',
  folderColorIndigo: 'Indigo',
  folderColorPurple: 'Violett',
  ...
  license: 'Lizenz',
  licenseDesc:
    'Sie können eine Lizenz für die Downloader auswählen, um die Verwendung der Anweisung Ihrer Karte einzuschränken.',
  ...
  confirmRemoveModuleFeature:
    'Möchten Sie diese Funktion wirklich entfernen? Diese Aktion kann nicht rückgängig gemacht werden.',
  ...
  persistentStorageFail:
    'Speicher ist nicht dauerhaft. Haben Sie die Anfrage abgelehnt oder wird der Browser nicht unterstützt?',
  persistentStorageRecommended: 'Dauerhafter Speicher empfohlen',
  persistentStorageDesc:
    'Ihr Browser unterstützt dauerhaften Speicher. Dies wird für eine bessere Leistung und Benutzererfahrung empfohlen.',
  enable: 'Aktivieren',
  ...
  log: 'Protokoll',
  popularityLevelDesc:
    'Beliebtheit steigt mit Downloads usw. Zur Schätzung: 3,7 Beliebtheit entspricht etwa 1 Download.',
  ...
  jsonDesc:
    'JSON-Format ist ein Format, das sowohl für Menschen als auch für Maschinen leicht zu lesen und zu schreiben ist.',
  nickname: 'Spitzname',
  ...
  importTranslationCacheConfirm:
    'Die Einträge werden in den Übersetzungscache zusammengeführt. Vorhandene Schlüssel werden überschrieben. Fortfahren?',
  importTranslationCacheSuccess: '{0} Übersetzungscache-Einträge importiert.',
  importTranslationCacheFailed:
    '{0} Einträge importiert, aber {1} Einträge konnten nicht gespeichert werden. Der Speicher ist möglicherweise voll.',
  ...
  clearTranslationCacheConfirm:
    'Alle Einträge im Übersetzungscache werden gelöscht. Dies kann nicht rückgängig gemacht werden. Fortfahren?',
  loading: 'Laden',
  ...
  hypaV3Modal: {
    ...
    previousSearchResultAction: 'Vorheriges Suchergebnis',
    nextSearchResultAction: 'Nächstes Suchergebnis',
    ...
    selectSummaryAction: 'Zusammenfassung #{0} auswählen',
    deselectSummaryAction: 'Auswahl von Zusammenfassung #{0} aufheben',
    summaryCategoryLabel: 'Kategorie für Zusammenfassung #{0}',
    toggleSummaryTranslationAction: 'Übersetzung der Zusammenfassung ein- oder ausblenden',
    toggleSummaryImportantAction: 'Wichtig-Markierung der Zusammenfassung umschalten',
    rerollSummaryAction: 'Zusammenfassung neu generieren',
    deleteSummaryAction: 'Zusammenfassung löschen',
    deleteFollowingSummariesAction: 'Nachfolgende Zusammenfassungen löschen',
    toggleRerolledSummaryTranslationAction: 'Übersetzung der neu generierten Zusammenfassung ein- oder ausblenden',
    cancelRerollAction: 'Neugenerierung der Zusammenfassung abbrechen',
    applyRerollAction: 'Neu generierte Zusammenfassung übernehmen',
    toggleConnectedMessageTranslationAction: 'Übersetzung der verbundenen Nachricht ein- oder ausblenden',
    bulkCategoryLabel: 'Kategorie für ausgewählte Zusammenfassungen',
    toggleBulkImportantAction: 'Wichtig-Markierung ausgewählter Zusammenfassungen umschalten',
    bulkSelectionInputLabel: 'Auszuwählende Zusammenfassungsnummern',
    toggleResummaryTranslationAction: 'Übersetzung der erneuten Zusammenfassung ein- oder ausblenden',
    retryResummaryAction: 'Erneute Zusammenfassung wiederholen',
    applyResummaryAction: 'Ergebnis der erneuten Zusammenfassung übernehmen',
    cancelResummaryAction: 'Erneute Zusammenfassung abbrechen',
    addCategoryAction: 'Kategorie hinzufügen',
    saveCategoryAction: 'Kategorie speichern',
    cancelCategoryEditAction: 'Kategoriebearbeitung abbrechen',
    editCategoryAction: 'Kategorie bearbeiten',
    deleteCategoryAction: 'Kategorie löschen',
    tagNameLabel: 'Tag-Name',
    saveTagAction: 'Tag speichern',
    cancelTagEditAction: 'Tag-Bearbeitung abbrechen',
    editTagAction: 'Tag bearbeiten',
    deleteTagAction: 'Tag löschen',
    refreshMemoryJobsAction: 'Speicheraufträge aktualisieren',
    resetConfirmMessage:
  ...
  childLoreDesc:
    "Dies ist eine Kopie des Charakter-Lores, das 'Immer aktiv' bleibt, bis es entfernt oder im Original manuell deaktiviert wird.",
  ...
  stackTraceTranslationFailed:
    'Die Übersetzung des Stack-Traces ist fehlgeschlagen. Unten wird der ursprüngliche verschleierte Stack-Trace angezeigt.',
  ...
  pluginRisksInuserFriendlyDesc: {
    ...
    globalAccess:
      'Das Plugin versucht, auf globale Variablen zuzugreifen, was zu unbeabsichtigten Nebenwirkungen oder Sicherheitslücken führen kann.',
    thisOutsideClass:
      "Das Plugin verwendet das Schlüsselwort 'this' außerhalb des Klassenkontexts, was zu unbeabsichtigtem Verhalten oder Sicherheitsproblemen führen kann.",
    errorInVerification:
      'Während des Überprüfungsprozesses des Plugins sind Fehler aufgetreten, was auf potenzielle Probleme mit seiner Funktionalität hinweist.',
    storageAccess:
      'Das Plugin versucht, auf den Speicher zuzugreifen, was zu Datenlecks oder unbefugter Datenmanipulation führen kann.',
  },
  generatedByAIDisclaimer:
    'Dieser Inhalt wurde von einer KI generiert und kann Ungenauigkeiten oder Verzerrungen enthalten.',
  aiGenerationWarning:
    'Die Inhalte werden von einer KI generiert und können Ungenauigkeiten oder Verzerrungen enthalten.',
  loadMore: 'Mehr laden',
  ...
  getFullDatabaseConsent:
    'Das Plugin {} möchte auf die gesamte Datenbank zugreifen, was zur Offenlegung sensibler Informationen führen kann. Möchten Sie dies zulassen?',
  mainDomAccessConsent:
    'Plugin {} möchte auf das Hauptdokument zugreifen, wodurch sensible Informationen offengelegt werden könnten. Möchten Sie dies zulassen?',
  ...
  settingsNavInputHooks: 'Eingabe-Hooks',
  inputHooks: 'Eingabe-Hooks',
  inputHookTypeDraft: 'Entwurf',
  inputHookTypeBtw: 'BTW',
  inputHookAdd: 'Hook hinzufügen',
  ...
  inputHookDraftPlaceholder: 'Die Hook-Ausgabe erscheint hier und kann vor dem Senden bearbeitet werden.',
  inputHookSelectDraft: 'Entwurfs-Hook auswählen',
  inputHookDraftDialogTitle: 'Entwurfs-Hook auswählen',
  inputHookNone: 'Keiner',
  inputHookBtw: 'BTW',
  inputHookBtwDialogTitle: 'BTW-Hook ausführen',
  inputHookBtwResult: 'BTW-Ergebnis',
  inputHookBtwDismiss: 'BTW-Ergebnis schließen',
  inputHookSendDraft: 'Entwurf senden',
