export const languageChinese = {
  connectedReaders: {
    chatOccupancy: {
      unsupported: '无法使用仅聊天访问',
      unsupportedHelp: '此服务器不支持仅聊天交互。你仍可继续阅读。',
      disabled: '仅聊天访问已关闭',
      disabledHelp: '暂时无法获取新的聊天访问权。你仍可继续阅读。',
      identityUnavailable: '此标签页无法使用仅聊天访问',
      identityUnavailableHelp: '请使用原标签页或重新加载此页面。你仍可在此阅读。',
      available: '可在此设备上使用',
      availableHelp: '请明确获取此聊天的使用权后再发送或重新生成。仅浏览不会占用聊天。',
      foreignOwned: '正在另一台设备上使用',
      ...
      normalizationRequiredHelp: '失去常规写入权限后，此设备保留了多个聊天。交互前请保留当前聊天。',
      normalizationElsewhere: '请先选择一个已保留的聊天',
      ...
      sendAccepted: '消息已接受。',
      sendQueued: '此消息仍保留在此设备上；目前尚无法确认服务器是否已接受。',
      sendFailed: '消息未被接受。你的草稿仍保留在这里。',
      rerollAccepted: '重新生成已接受。',
      rerollRetained: '重新生成请求仍保留在此设备上；目前尚无法确认服务器是否已接受。',
      rerollFailed: '重新生成未被接受。现有回复未更改。',
      stopRequested: '已请求停止。正在等待服务器协调回复。',
      stopFailed: '无法确认停止。生成可能仍在进行。',
      actionUnavailable: '当前无法执行此操作。请刷新后重试。',
      actionFailed: '无法更改聊天访问权。请刷新后重试。',
      recoveryBlocked: '必须先等待已接受的任务完成或将其停止，才能释放或切换此聊天。',
    },
  },
  generationRecovery: {
    failed: '应用无法完成先前生成的恢复。新消息已暂停，但你的草稿仍会保留。',
    retry: '重试恢复',
    retrying: '正在重试恢复…',
    discard: '放弃恢复',
    discarding: '正在放弃恢复…',
  ...
  errors: {
    ...
    networkFetchWeb:
      '这可能是由浏览器限制引起的 CORS 错误。请在 Fastify 服务器上运行 RisuAI，以便请求通过服务器端代理转发。',
  ...
  showHelp: '显示帮助',
  help: {
    hypaV3ProgressOpenChatOnly: '仅为当前打开的聊天显示完整的记忆任务指示器，其他聊天中的任务仍会以紧凑计数显示。',
    ...
    charjs:
      '这是一段会与角色一同运行的 JavaScript。详情请查看：https://github.com/kwaroran/RisuAI/blob/main/src/etc/example-char.js\n**出于安全原因，目前不建议使用。这些代码不会被包含在导出中。**',
    romanizer:
    ...
    promptInfoInsideChatDesc:
      '启用后，这会将提示预设信息存储在聊天元数据中。存储的数据包括预设名称、活动切换和提示文本。这可能会略微增加处理时间和存储使用量。',
    ...
    openRouterProviderIgnore:
      '忽略此列表中的提供商，若所有提供商都被忽略，请求将会失败。详见 https://openrouter.ai/docs/guides/routing/provider-selection#ignoring-providers',
    additionalPrompt:
    ...
    enableScrollToActiveChar:
      '如果启用，在拖动角色时按下热键或按住 Ctrl 键将滚动到当前活跃的角色。如果文件夹已关闭，将自动打开。',
  },
  setup: {
  ...
  triggerDesc: {
    ...
    v2ExtractRegex: '提取正则',
    v2ExtractRegexDesc:
      '使用正则 {{regexType}} {{regex}} 和标志 {{flagsType}} {{flags}} 从 {{value}} 中提取文本，并将结果存储为 {{resultType}} {{result}} => {{outputVar}}',
    v2RegexTest: '正则测试',
  ...
  reroll: '重新生成',
  chatList: '聊天列表',
  chatListExportAll: '导出所有聊天',
  chatListImport: '导入聊天',
  chatListEdit: '编辑聊天列表',
  chatListCreateFolder: '创建聊天文件夹',
  ...
  doNotWarnExternalServers: '不再警告外部服务器',
  altGreet: '备选初始消息',
  scripts: '脚本',
  settings: '设置',
  selective: '选择性',
  ...
  hypaV3ProgressOpenChatOnly: '仅显示当前聊天的完整记忆进度',
  ...
  folderActionsFor: (name: string) => `${name} 的文件夹操作`,
  moveToFolder: '移动到文件夹',
  moveOutOfFolder: '移出文件夹',
  createFolderWith: '与其他角色创建文件夹…',
  chooseDestinationFolder: '选择目标文件夹',
  chooseFolderPartner: '选择要放入新文件夹的角色',
  newCharacterFolderName: '新文件夹',
  chooseFolderColor: '选择文件夹颜色',
  resetFolderImage: '重置为默认图片',
  selectFolderImageFile: '选择图片文件',
  folderColorRed: '红色',
  folderColorGreen: '绿色',
  folderColorBlue: '蓝色',
  folderColorYellow: '黄色',
  folderColorIndigo: '靛蓝色',
  ...
  hypaV3Progress: {
    activeJobs: (count: number) => `${count} 个进行中的记忆任务`,
    activeInOtherChats: (count: number) => `其他聊天中有 ${count} 个进行中的记忆任务`,
    otherChatsCompact: (count: number) => `其他聊天 +${count}`,
    openDetailsAction: (count: number) => `显示 ${count} 个进行中的记忆任务详情`,
    closeDetailsAction: '隐藏记忆任务详情',
    unnamedChat: '未命名聊天',
    unknownChat: (id: string) => `聊天 ${id}`,
    kind: { chunk: '准备记忆', embed: '搜索记忆', summarize: '总结记忆' },
    pending: '等待中',
    running: '运行中',
    attempt: (attemptCount: number, maxAttempts: number) => `尝试 ${attemptCount}/${maxAttempts}`,
  },
  hypaV3Modal: {
    titleLabel: 'HypaV3',
    searchAction: '搜索摘要',
    previousSearchResultAction: '上一个搜索结果',
    nextSearchResultAction: '下一个搜索结果',
    importantFilterAction: '仅显示重要摘要',
    bulkEditAction: '批量编辑摘要',
    categoryManagerAction: '管理分类',
    settingsAction: '打开 HypaV3 设置',
    moreActionsAction: '更多操作',
    selectedFilterAction: '仅显示所选摘要',
    resetDataAction: '重置 HypaV3 数据',
    closeAction: '关闭 HypaV3',
    selectSummaryAction: '选择摘要 #{0}',
    deselectSummaryAction: '取消选择摘要 #{0}',
    summaryCategoryLabel: '摘要 #{0} 的分类',
    toggleSummaryTranslationAction: '显示或隐藏摘要翻译',
    toggleSummaryImportantAction: '切换摘要的重要标记',
    rerollSummaryAction: '重新生成摘要',
    deleteSummaryAction: '删除摘要',
    deleteFollowingSummariesAction: '删除后续摘要',
    toggleRerolledSummaryTranslationAction: '显示或隐藏重新生成摘要的翻译',
    cancelRerollAction: '取消重新生成摘要',
    applyRerollAction: '应用重新生成的摘要',
    toggleConnectedMessageTranslationAction: '显示或隐藏关联消息翻译',
    bulkCategoryLabel: '所选摘要的分类',
    toggleBulkImportantAction: '切换所选摘要的重要标记',
    bulkSelectionInputLabel: '要选择的摘要编号',
    toggleResummaryTranslationAction: '显示或隐藏重新总结翻译',
    retryResummaryAction: '重试重新总结',
    applyResummaryAction: '应用重新总结结果',
    cancelResummaryAction: '取消重新总结',
    addCategoryAction: '添加分类',
    saveCategoryAction: '保存分类',
    cancelCategoryEditAction: '取消编辑分类',
    editCategoryAction: '编辑分类',
    deleteCategoryAction: '删除分类',
    tagNameLabel: '标签名称',
    saveTagAction: '保存标签',
    cancelTagEditAction: '取消编辑标签',
    editTagAction: '编辑标签',
    deleteTagAction: '删除标签',
    refreshMemoryJobsAction: '刷新内存任务',
  ...
  inputHookSelectDraft: '选择草稿钩子',
  inputHookDraftDialogTitle: '选择草稿钩子',
  inputHookNone: '无',
  inputHookBtw: 'BTW',
  inputHookBtwDialogTitle: '运行 BTW 钩子',
  inputHookBtwResult: 'BTW 结果',
  inputHookBtwDismiss: '关闭 BTW 结果',
  inputHookSendDraft: '发送草稿',
