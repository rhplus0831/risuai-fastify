  ...
  class="{styled === 'primary'
    ...
    : styled === 'outlined'
      ...
      : (selected ? 'bg-red-800' : 'bg-red-700') +
        ' hover:bg-red-500 focus:ring-red-600 border-red-600'} border text-textcolor rounded-md shadow-xs focus:outline-hidden focus:ring-2 transition-colors duration-200{className
    ? ' ' + className
    : ''}"
