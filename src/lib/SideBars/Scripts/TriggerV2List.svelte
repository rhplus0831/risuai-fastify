      ...
      try {
        if (triggerScrollRef && typeof triggerScrollRef.scrollTop === 'number') {
          if (menuMode === 0) {
            ...
            const positions = this.otherModeScrollPositions.get(menuMode) || {
              menu0: 0,
              trigger: 0,
            }
            positions.trigger = triggerScrollRef.scrollTop
...
{#if selectedIndex > 0}
  <Portal>
    ...
    <div
      ...
      {/if}
      <div
        class="max-w-full p-2 border border-darkborderc bg-bgcolor flex max-h-full flex-col-reverse md:flex-row overflow-y-auto md:overflow-y-visible"
          ...
          <div class="pr-2 md:w-96 flex flex-col md:h-full mt-2 md:mt-0">
            ...
            <div
              ...
              {#each value as trigger, i}
                ...
                {:else}
                  <div
                    class="w-full h-0.5 min-h-0.5 transition-all duration-200"
