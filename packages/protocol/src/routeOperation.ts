...
export const PROTOCOL_ROUTE_OPERATION_CATALOG = [
  ...
  },
  {
    ...
    methods: ['POST'],
    path: '/api/v1/chat-occupancies/:chatId/claim',
    match: 'pattern',
    streaming: 'none',
    cache: 'no-store',
    durability: 'none',
  ...
  },
  {
    ...
    methods: ['PUT'],
    path: '/api/v1/chat-occupancies/:chatId/lease',
    match: 'pattern',
    streaming: 'none',
    cache: 'no-store',
    durability: 'none',
  ...
  },
  {
    ...
    methods: ['DELETE'],
    path: '/api/v1/chat-occupancies/:chatId',
    match: 'pattern',
    streaming: 'none',
    cache: 'no-store',
    durability: 'none',
  ...
  },
  {
    ...
    methods: ['POST'],
    path: '/api/v1/chat-occupancies/switch',
    match: 'exact',
    streaming: 'none',
    cache: 'no-store',
    durability: 'none',
  ...
  },
  {
    ...
    methods: ['POST'],
    path: '/api/v1/chat-occupancies/normalize',
    match: 'exact',
    streaming: 'none',
    cache: 'no-store',
    durability: 'none',
  ...
  },
  {
    ...
    methods: ['PUT'],
    path: '/api/v1/generation-effects/:generationId/igp/commit',
    match: 'pattern',
    streaming: 'none',
    cache: 'unspecified',
    durability: 'revisioned-command',
  ...
  },
  {
    ...
    methods: ['PUT'],
    path: '/api/v1/generation-effects/:generationId/igp/inlay-preparation',
    match: 'pattern',
    streaming: 'none',
    cache: 'unspecified',
    durability: 'revisioned-command',
  ...
  },
  {
    ...
    methods: ['PUT'],
    path: '/api/v1/generation-effects/:generationId/igp/inlay-finalization',
    match: 'pattern',
    streaming: 'none',
    cache: 'unspecified',
    durability: 'revisioned-command',
  ...
  },
  {
    ...
    methods: ['PUT'],
    path: '/api/v1/generation-effects/:generationId/igp/inlay-abandonment',
    match: 'pattern',
    streaming: 'none',
    cache: 'unspecified',
    durability: 'revisioned-command',
  ...
  },
  {
    ...
    methods: ['POST'],
    path: '/api/v1/generation-effects/:generationId/igp/completion',
    match: 'pattern',
    streaming: 'none',
    cache: 'no-store',
    durability: 'durable-generation',
