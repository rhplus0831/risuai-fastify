...
| A generation is rejected, blocked, or stops before the provider runs, or a new guard is added | [Generation Rejection Register](docs/structure/generation-rejection-register.md) |
