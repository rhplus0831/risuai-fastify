...
`server/fastify/browser-smoke/chatOccupancyInteraction.spec.ts` extends this
boundary to real separate BrowserContexts. It verifies overlapping provider work
...
- `chatOccupancyInteraction.spec.ts`, occupied-operation client tests, and
