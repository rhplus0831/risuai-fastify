...
| Connected read-only clients | Phase 0 accepted; capability protection next    | [Plan](connected-read-only-clients/PLAN.md), [execution status](connected-read-only-clients/status.md) |
