...
| --------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Browser smoke effectiveness | Phase 0 accepted; shared harnesses next   | [Plan](browser-smoke-effectiveness/PLAN.md), [execution status](browser-smoke-effectiveness/status.md) |
